...
--
-- Host: localhost    Database: bukusaku_shintia
-- ------------------------------------------------------
...
INSERT INTO `books` VALUES (1,'Buku Cinta Pertama - Love Story by Shintia','shintia','covers/UDiIrSaNvdHxXhR44J3oYfwyJxQETKzELP4LzX5u.jpg',2024,103,'2024-12-20 07:30:15','2024-12-20 07:38:25');
...
INSERT INTO `transactions` VALUES (1,1,1,'2024-12-20','2024-12-20','returned','2024-12-20 07:31:00','2024-12-20 07:31:05');
...
CREATE TABLE `users` (
  ...
  `mata_kuliah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'user','user@gmail.com','$2y$12$ftx7IsA86iZUQr6jLniip.M5woZ82Dl7I5UzocPAOgvzS2bqmiVl2','admin',NULL,NULL,NULL,'2024-12-20 07:27:38','2024-12-20 07:27:38');
...
-- Dump completed on 2024-12-20 22:13:08
